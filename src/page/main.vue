    ...
    <div class="main" :class="{'main-hide-text': shrink}">
        ...
        <div class="main-header-con" :style="{paddingLeft: shrink?'60px':'200px'}">
            <div class="main-header">
                <div class="navicon-con" v-show="showFlag">
                    <Button :style="{transform: 'rotateZ(' + (this.shrink ? '-90' : '0') + 'deg)'}" type="text" @click="toggleClick">
                        <Icon type="navicon" size="32"></Icon>
                    </Button>
                </div>
                <div class="header-middle-con" v-show="showFlag">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            avatorPath () {
                return localStorage.avatorImgPath?localStorage.avatorImgPath:"https://i.loli.net/2017/08/21/599a521472424.jpg";
            },
            cachePage () {
        ...
        methods: {
            init () {
                ...
                if (pathArr.length >= 2) {
                    this.$store.commit('ADD_OPENSUBMENU', pathArr[1].name);
                }
                this.userName = Cookies.get('user');
                let messageCount = 3;
                this.messageCount = messageCount.toString();
                this.checkTag(this.$route.name);
                this.$store.commit('SET_MESSAGECOUNT', 3);
            },
            toggleClick () {
